...
import me.kimeunsoo.springbootdeveloper.Code;
...
class QuizControllerTest {
    ...
    @DisplayName("quiz() : POST /quiz?code=1 이면 자동 응답은 403, 응답 본문은 Forbidden! 을 반환한다.")
    @Test
...
/*
    ObjectMapper : Jackson 라이브러리에서 제공하는 클래스로 객체를 JSON간 변환을 처리
    ...
    writeValueAsString(code) 메서드를 통해서 JSON 문자열 혈태로 객체가 변환.
