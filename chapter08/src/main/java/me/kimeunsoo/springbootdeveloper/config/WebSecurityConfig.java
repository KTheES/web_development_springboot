package me.kimeunsoo.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.kimeunsoo.springbootdeveloper.service.UserDetailService;
...
/*
    ...
    5. 로그아웃 설정.
        ...
        invalidateHttpSession() : 로그아웃 이후에 세션을 전체 삭제할지 여부를 설정 -> 저희는 true 설정
    ...
    8. 사용자 서버를 설정
        userDetailService :사용자 정보를 가져올 서비스를 설정. 이 때 설정하는 서비스 클래스는 방드시
