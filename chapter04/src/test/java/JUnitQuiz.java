...
// import static의 경우 종종 보게 될텐데 정적 메서드에 해당하는 것을 가져올 떄 쓰입니다.
...
public class JUnitQuiz {
    ...
    public void junitTest2(){
        /*
            문제 02.
                int로 선언된 변수 3개가 있습니다. number1, number2 , number3 는 각각 15 , 0, -5
                세 변수가 각각 양수, 0 , 음수이고, number1은 number2보다 큰 값이고,
                number3은 number2보다 작은 값임을 검증하는 테스트를 작성해보세요.
         */
        int number1 = 15;
        int number2 = 0;
        int number3 = -5;
        ...
        assertThat(number2).isZero();   //양수인지 확인하면 false / 음수인지 확인해도 falsw
